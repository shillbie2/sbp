...
#line = LINE()
#line = LINE("Eqxs3JHU5qUFjAdDpVXb.w6+8YbOkbOMyiHAGbC+hcW.QfgZq0tKyYgmDc0RpF3AIfOVfJjMv0wkC0O8DuvNyXo=")
line = LINE("riobrowniz.rh@gmail.com","rio13021994")
    ...
    try:
        ...
        if op.type == 17:
        	if settings["Sambutan"] == True:
                    ...
                    line.sendMessage(op.param1,"welkam ya " + line.getContact(op.param2).displayName + "\nwekam To -> " + str(group.name) + " <-" + "\nlangsung cek ja membr nya... \nkali ja lu dapet anu...")
        if op.type == 15:
        	if settings["Sambutan"] == True:
                    if op.param2 in lineMID:
                        return
                    ...
                    image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
                    line.sendImageWithURL(op.param1,image)
                    line.sendMessage(op.param1,"selamat tinggal " + line.getContact(op.param2).displayName +  "\nSemoga tenang di alam sana yah...")
            ...
            if msg.text != None:
                if msg.toType == 2:
                    ...
                    if may in str(msg.contentMetadata) and 'MENTION' in str(msg.contentMetadata):
                        ...
                        line.sendMessage(msg.to, str(rslt))
                    else:
                        pass
                else:
                    pass
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    line.sendContact(to, "u5baffcc81a0a0689982216a005cfc70b")
...
#==============================================================================#
                ...
                elif msg.text.lower().startswith("getlcontact "):
                ...
                elif msg.text.lower().startswith("getvideoprofile "):
                    if 'MENTION' in msg.contentMetadata.keys()!= None:
                        names = re.findall(r'@(\w+)', text)
                        mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                        mentionees = mention['MENTIONEES']
                    ...
                    if 'MENTION' in msg.contentMetadata.keys()!= None:
                        ...
                        try:
                            ...
                            line.sendMessage(msg.to, "Berhasil Copy target...")
                        except:
                            line.sendMessage(msg.to, "Gagal Copy target...")
                elif text.lower() == 'semula':
                    try:
                        ...
                        line.sendMessage(msg.to, "Berhasil Seperti Semula...")
                    except:
                        line.sendMessage(msg.to, "Gagal Seperti Semula...")
#==============================================================================#
...
#==============================================================================#          
                    ...
                    if msg.to in read['readPoint']:
                            ...
                            with open('read.json', 'w') as fp:
                                ...
                                line.sendMessage(msg.to,"Cctv on, Siap cyduk...")
                    else:
                        try:
                            del read['readPoint'][msg.to]
                            del read['readMember'][msg.to]
                    ...
                    if msg.to not in read['readPoint']:
                        line.sendMessage(msg.to,"Cctv off...")
                    else:
                        try:
                            del read['readPoint'][msg.to]
                            del read['readMember'][msg.to]
                    ...
                    if msg.to in read["readPoint"]:
                        ...
                        line.sendMessage(msg.to, "Cctv belum diaktifkan ngapain di reset?")
                        
                elif text.lower() == 'cyduk':
                    tz = pytz.timezone("Asia/Jakarta")
                    timeNow = datetime.now(tz=tz)
                    day = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday","Friday", "Saturday"]
                    hari = ["Minggu", "Senin", "Selasa", "Rabu", "Kamis", "Jumat", "Sabtu"]
                    ...
                    if receiver in read['readPoint']:
                        ...
                        line.sendMessage(receiver,"ONin dulu Cctvnya bos...")
#===========(kick user)====================#
                elif "dor " in text.lower(): 
                        try:
                            key = eval(msg.contentMetadata["MENTION"])
                            u = key["MENTIONEES"][0]["M"]
                            line.sendMessage(receiver,'Maav y...')
                            line.kickoutFromGroup(receiver,[u])
                        except:
                            line.sendMessage(receiver, 'request blocked')
#==============================================================================#
                        ...
                        for mention in mentionees:
                            if lineMID in mention["M"]:
                                if settings["detectMention"] == True:
                                    ...
                                    line.sendMessage(to, "jan tag ue...")
